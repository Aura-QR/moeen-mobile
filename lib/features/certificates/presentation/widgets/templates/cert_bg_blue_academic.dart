...
/// Template 3 — "تعليمي أزرق" (Blue Academic)
///
/// React reference (default / fallback case):
/// ```
...
/// `bg-gradient-to-l from-A to-B` → right=A (accent), left=B (dark).
class CertBgBlueAcademic extends StatelessWidget {
  final CertificateTemplateModel template;

  const CertBgBlueAcademic({super.key, required this.template});
