...
class CurriculumDistributionScreen extends StatefulWidget {
  ...
  @override
  State<CurriculumDistributionScreen> createState() =>
      _CurriculumDistributionScreenState();
}

class _CurriculumDistributionScreenState
    extends State<CurriculumDistributionScreen> {
  // Stage / Grade / Subject tree
  ...
  // Region switcher
  String _selectedRegion = 'general'; // 'general' | 'west'
